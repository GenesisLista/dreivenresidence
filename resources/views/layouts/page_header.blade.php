                ...
                <!-- <ul class="nav nav-pills">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#"><img class="w20 mr-2" src="{{ asset('public/images/flags/us.svg') }}">English</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#"><img class="w20 mr-2" src="{{ asset('public/images/flags/es.svg') }}">Spanish</a>
                            <a class="dropdown-item" href="#"><img class="w20 mr-2" src="{{ asset('public/images/flags/jp.svg') }}">japanese</a>
                            <a class="dropdown-item" href="#"><img class="w20 mr-2" src="{{ asset('public/images/flags/bl.svg') }}">France</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                            ...
                            <ul class="right_chat list-unstyled w250 p-0">
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{ asset('public/images/xs/avatar4.jpg') }}" alt="">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{ asset('public/images/xs/avatar5.jpg') }}" alt="">
                                            <div class="media-body">
                                ...
                                <li class="offline">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{ asset('public/images/xs/avatar2.jpg') }}" alt="">
                                            <div class="media-body">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{ asset('public/images/xs/avatar3.jpg') }}" alt="">
                                            <div class="media-body">
