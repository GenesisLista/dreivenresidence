...
@section('title', 'List Active Rental')
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            <ul class="nav nav-tabs page-header-tab">
                <li class="nav-item"><a class="nav-link active" href="javascript:void(0)">Active Rentals</a></li>
            </ul>
            <div class="header-action">
                <a class="btn btn-primary" href="{{ route('active-rental.create') }}"><i class="fe fe-plus mr-2"></i> Add</a>
            </div>
        </div>
    </div>
</div>
