...
@section('title', 'List Active Tenant')
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            <ul class="nav nav-tabs page-header-tab">
                <li class="nav-item"><a class="nav-link active" href="javascript:void(0)">Active Tenants</a></li>
            </ul>
            <div class="header-action">
                <a class="btn btn-primary" href="{{ route('active-tenant.create') }}"><i class="fe fe-plus mr-2"></i> Add</a>
            </div>
        </div>
    </div>
</div>
                            ...
                            <table class="table table-hover js-basic-example dataTable table_custom border-style spacing5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <a href="{{ route('active-tenant.show', $tenantlist->id) }}"><button class="btn btn-sm btn-icon on-default m-r-5" data-toggle="tooltip" data-original-title="Show"><i class="icon-doc" aria-hidden="true"></i></button></a>
                                            ...
                                            <form method="post" action="{{ route('active-tenant.destroy', $tenantlist->id) }}">
                                                @method('DELETE')
