    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            <ul class="nav nav-tabs page-header-tab">
                ...
                <li class="nav-item"><a class="nav-link" href="javascript:void(0)">Not Active Tenants</a></li>
            </ul>
            <div class="header-action">
                <a class="btn btn-primary" href="{{ route('tenant.create') }}"><i class="fe fe-plus mr-2"></i> Add</a>
            </div>
        </div>
    </div>
</div>
                            ...
                            <table class="table table-hover js-basic-example dataTable table_custom border-style spacing5">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$320,800</td>
                                        <td class="actions">
                                            <a href="{{ route('tenant.show', 0) }}"><button class="btn btn-sm btn-icon on-default m-r-5" data-toggle="tooltip" data-original-title="Show"><i class="icon-doc" aria-hidden="true"></i></button></a>
