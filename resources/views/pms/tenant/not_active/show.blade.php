...
@section('title', 'Show Not Active Tenant')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">Not Active Tenants</h2>
            </div>
            <div class="card-body">
                <div class="row clearfix">
                    ...
                    <div class="col-12">
                        <a class="btn btn-warning" href="{{ route('not-active-tenant.index') }}"><i class="fe fe-arrow-left mr-2"></i>Back</a>
                    </div>
                </div>
            </div>
        </div>
