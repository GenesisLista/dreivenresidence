                            ...
                            <table class="table table-hover js-basic-example dataTable table_custom border-style spacing5">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$320,800</td>
                                        <td class="actions">
                                            <a href="{{ route('alr-building.show', 0) }}"><button class="btn btn-sm btn-icon on-default m-r-5" data-toggle="tooltip" data-original-title="Show"><i class="icon-doc" aria-hidden="true"></i></button></a>
