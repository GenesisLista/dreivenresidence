...
@section('title', 'Show Roxas District Apartment')
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">Roxas District Apartment</h2>
                <div class="card-options">
                    <a href="{{ route('roxas-district.edit', $apartment_list->id) }}"><i class="fe fe-edit"></i></a>
                </div>
            </div>
            <div class="card-body">
                <div class="row clearfix">
                    ...
                    <div class="col-12">
                        <a class="btn btn-warning" href="{{ route('roxas-district.index') }}"><i class="fe fe-arrow-left mr-2"></i>Back</a>
                    </div>
                </div>
            </div>
        </div>
