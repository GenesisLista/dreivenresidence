...
@section('title', 'Edit Sampaloc Apt.')

@section('content')
<div class="section-body mt-3">
    <div class="container-fluid">
        <form action="{{ route('sampaloc.update', $apartment_list->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            {{ csrf_field() }}
            <div class="card">
                <div class="card-body">
                    <div class="row clearfix">
                        ...
                        <div class="col-12">
                            ...
                            <a class="btn btn-warning" href="{{ route('sampaloc.show', $apartment_list->id) }}"><i class="fe fe-arrow-left mr-2"></i>Back</a>
                        </div>
                    </div>
                </div>
            </div>
