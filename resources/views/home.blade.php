        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="mb-4">
                    ...
                    <small>Dreiven Residences Property Management System</small>
                </div>
            </div>
        </div>
        <div class="row clearfix">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-unstyled team-info sm margin-0 w150">
                                                <li><img src="{{ asset('public/images/xs/avatar1.jpg') }}" alt="Avatar"></li>
                                                <li><img src="{{ asset('public/images/xs/avatar2.jpg') }}" alt="Avatar"></li>
                                                <li><img src="{{ asset('public/images/xs/avatar3.jpg') }}" alt="Avatar"></li>
                                                <li><img src="{{ asset('public/images/xs/avatar4.jpg') }}" alt="Avatar"></li>
